...
type
  TdtmProdutos = class(TdtmCadastro)
    cdsCadastroidProdutos: TIntegerField;
    cdsCadastronome: TStringField;
    cdsCadastrovalor: TBCDField;
    fdqCadastroidProdutos: TIntegerField;
    fdqCadastronome: TStringField;
    fdqCadastrovalor: TBCDField;
    fdqConsultaidProdutos: TIntegerField;
...
begin
  ...
  cdsCadastroidprodutos.AsInteger := dtmConexao.getProxId('produtos', 'idProdutos');
end;
