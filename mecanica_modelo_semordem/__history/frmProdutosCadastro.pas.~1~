...
begin
  inherited;
  formProdutosConsulta := formProdutosConsulta.Create(self);
  try
    ...
    begin
      ...
      dtmProdutos.cdsCadastro.Locate('idProdutos', dtmProdutos.fdqConsultaidProdutos.AsInteger, []); // id desejado
    end;
  finally
